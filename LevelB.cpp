...
unsigned int LevelB_DATA[] =
{
   ...
   12, 16, 23, 23, 23, 19, 23, 23, 23, 23, 19, 23, 23, 17, 12,
   12, 13, 10, 10, 10, 14, 10, 10, 10, 10, 14, 10, 10, 11, 12,
   12, 13, 10, 10, 10, 14, 10, 10, 10, 10, 14, 10, 10, 11, 12,
   12, 13, 10, 10, 10, 25, 10, 10, 10, 10, 14, 10, 10, 11, 12,
   12, 13, 10, 10, 10, 10, 10, 10, 10, 10, 25, 10, 10, 11, 12,
   12, 13, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 11, 12,
   12, 13, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 11, 12,
   12, 13, 10, 10, 10, 10, 10,  3, 10, 10, 10, 10, 10, 11, 12,
   12, 13, 10, 10, 10, 10, 10, 14, 10, 10, 10, 10, 10, 11, 12,
   12, 13, 10, 10, 10, 10, 10, 14, 10, 10, 10, 10, 10, 11, 12,
   12, 68,  1,  1,  1,  1,  1, 30,  1,  1,  1,  1,  1, 71, 12,
   12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12
};
...
void LevelB::initialise()
{
    ...
    GLuint map_texture_id = Utility::load_texture("assets/Cliff.png");
...
glm::vec3 LevelB::avoid_map(float r_edge, float l_edge, float t_edge, float b_edge) {
